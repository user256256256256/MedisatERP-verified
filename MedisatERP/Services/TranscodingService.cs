...
namespace MedisatERP.Services
{
    ...
    /* Transcoding generally refers to the process of converting data from one format to another,
    which can involve both encoding (converting data into a particular format) and decoding (reversing the process). */
