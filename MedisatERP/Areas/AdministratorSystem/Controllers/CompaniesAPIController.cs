...
namespace MedisatERP.Controllers
{
    ...
    {
        private readonly AdministratorSystemDbContext _context;
        ...
        public CompaniesAPIController(AdministratorSystemDbContext context, NotificationService notificationService, IErrorCodeService errorCodeService, RoleRedirectService roleRedirectService)
        {
            _context = context;
