...
namespace MedisatERP.Controllers
{
    ...
    public class CompanyClientsAPIController : Controller
    {
        ...
        public async Task<IActionResult> Get(DataSourceLoadOptions loadOptions, Guid companyId)
        {
            try
            {
                var companyclients = _administratorSystemDbContext.CompanyClients
        ...
        public async Task<IActionResult> Post(string values)
        {
            ...
            try
            {
                ...
                _administratorSystemDbContext.CompanyClients.Add(model);
                await _administratorSystemDbContext.SaveChangesAsync();
        ...
        public async Task<IActionResult> Delete(Guid key)
        {
            try
            {
                ...
                if (model.Address != null)
                {
                    ...
                    _administratorSystemDbContext.ClientAddresses.Remove(model.Address);
                }

                // Log the removal of the company client itself
                Console.WriteLine($"Removing CompanyClient with ID: {key}");
                _administratorSystemDbContext.CompanyClients.Remove(model);
        ...
        public async Task<IActionResult> CompaniesLookup(DataSourceLoadOptions loadOptions)
        {
            try
            {
                var lookup = from i in _administratorSystemDbContext.Companies
