...
namespace MedisatERP.Controllers
{
    ...
    public class TrialsAPIController : Controller
    {
        private ApplicationDbContext _context;
        private readonly ExceptionHandlerService _exceptionHandlerService;
        private ILogger<TrialsAPIController> _logger;

        public TrialsAPIController(ApplicationDbContext context, ILogger<TrialsAPIController> logger, ExceptionHandlerService exceptionHandlerService)
        {
            _context = context;
            _logger = logger;
        ...
        public async Task<IActionResult> Get(DataSourceLoadOptions loadOptions)
        {
            try
            {
                ...
                return Json(await DataSourceLoader.LoadAsync(trialnotifications, loadOptions));
            }
            catch (Exception ex)
            {
