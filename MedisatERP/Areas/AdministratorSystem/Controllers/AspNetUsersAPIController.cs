...
namespace MedisatERP.Controllers
{
    ...
    public class AspNetUsersAPIController : Controller
    {
        ...
        public AspNetUsersAPIController(AdministratorSystemDbContext context, UserManager<IdentityUser> userManager, NotificationService notificationService, IErrorCodeService errorCodeService)
        {
            _context = context;
